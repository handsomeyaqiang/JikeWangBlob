    ...
    function putInArticle(data) {
        ...
        var articleTop = $('<article-top><div class="article-title">' +
            ...
            '多年以后，愿你的城市，有清风，有烈酒，也有人是你的归途。<span class="article-i-say-me">--- JikeWang</span>' +
            '</div>');
        ...
        var articleFooter = $('<div class="end-logo">' +
            ...
            '</p>' +
            '<p class="show-weixin-pic">欢迎关注我的微信公众号：jikewang</p>' +
        ...
        $('.other').append($('<div class="social-share" data-initialized="true" data-url="' + data.articleUrl  + '"  data-title="' + data.articleTitle + '">' +
