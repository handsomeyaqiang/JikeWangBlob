...
//    }
     ...
     * @return File类型文件
     */
    public String multipartFileToFile(MultipartFile multipartFile, String filePath,String subCatalog, String fileName){
        File f = null;
        File dir = new File(filePath + subCatalog);
        if (!dir.exists() && !dir.isDirectory()) {
            dir.mkdirs();
        }
        if(StringUtil.BLANK.equals(multipartFile) || multipartFile.getSize() <= 0){
            ...
            try {
                ...
                f = new File(filePath + subCatalog + fileName);
        ...
        return "http://localhost:8089/" + subCatalog + fileName;
    }
